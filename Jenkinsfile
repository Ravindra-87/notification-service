pipeline {
    ...
    environment {
       ...
       //docker image details
        IMAGE_URL = 'asia-south1-docker.pkg.dev/multi-micro-project/mutli-micro-repo/notification-service-project'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git branch: 'main', credentialsId: 'github-access-id', url: 'https://github.com/Ravindra-87/notification-service.git'
            }
        }
